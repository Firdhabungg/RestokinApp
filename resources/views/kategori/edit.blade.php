                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi_kategori" id="deskripsi_kategori" rows="3"
                            ...
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">{{ old('deskripsi_kategori', $kategori->deskripsi_kategori) }}</textarea>
                    </div>
                </div>

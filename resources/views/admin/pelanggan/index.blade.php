...
@section('content')
    <div class="bg-white border border-gray-100 rounded-xl shadow-sm p-6 space-y-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div class="flex-1 flex flex-col md:flex-row gap-4">
                ...
                <div class="relative flex-1">
                    ...
                    <input type="text" id="searchInput" placeholder="Cari nama toko atau pemilik..."
                        class="w-full pl-10 pr-4 py-2.5 bg-gray-50 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none transition-all">
                </div>
                ...
                <div class="flex gap-3">
                    ...
                    <div class="relative">
                        ...
                        <select id="filterPaket"
                            class="appearance-none pl-10 pr-10 py-2.5 bg-gray-50 rounded-xl text-sm font-semibold text-gray-600 focus:ring-2 focus:ring-blue-500 outline-none cursor-pointer">
            ...
            <a href="#"
                class="bg-blue-500 text-white px-4 py-2.5 rounded-xl hover:bg-blue-600 shadow-sm transition-all text-sm font-semibold">

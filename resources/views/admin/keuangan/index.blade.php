                ...
                <div class="flex flex-wrap gap-3">
                    <div class="relative">
                        ...
                        <input type="text" id="searchInput" placeholder="Cari invoice / toko..."
                            class="pl-10 pr-4 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    </div>

                    <select id="statusFilter"
                        class="px-4 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg font-semibold text-gray-600 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="overflow-x-auto">
                    <table id="invoiceTable" class="w-full text-left border-collapse">
                        <thead class="bg-gray-50 text-gray-700 border-b border-gray-200">
                            <tr
                                class="border-b border-gray-400 text-gray-600 text-[12px] font-bold uppercase tracking-widest">
                            ...
                            @forelse ($payments as $payment)
                                <tr class="hover:bg-gray-50/60 transition-colors">
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        <span
                                            class="px-2 py-0.5 rounded-full bg-{{ $payment->status_color }}-50 text-{{ $payment->status_color }}-600 text-[11px] font-bold">
                                ...
                                <tr>
                                    <td colspan="7" class="px-4 py-12 text-center">
                                        <div class="flex flex-col items-center gap-2">
                                            ...
                                            <p class="text-gray-400 text-sm">Invoice akan muncul setelah ada transaksi
                                                pembayaran</p>
                                        </div>
                                    </td>
                                </tr>

    ...
    <div class="bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md">
        <div class="px-4 py-3 flex items-center justify-center gap-4 flex-wrap">
            <div class="flex items-center gap-2">
                ...
                <span class="text-blue-200 text-sm hidden sm:inline">
            ...
            <form action="{{ route('admin.akses-toko.stop') }}" method="POST" class="inline">
                @csrf
                <button type="submit" 
                    class="flex items-center gap-2 px-4 py-1.5 bg-white text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition-colors text-sm">

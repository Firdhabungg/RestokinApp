            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="flex gap-3 mb-4">
                    <button type="button" onclick="openProductModal()"
                        class="flex-1 border border-gray-300 rounded-lg px-4 py-2.5 text-left text-gray-500 hover:border-blue-500 hover:bg-blue-50 transition-colors">
                ...
                <div id="selectedProductPreview" class="hidden bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                    ...
                    <tbody>
                        @foreach ($barangs as $barang)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="px-2 py-1 rounded-full text-xs font-medium {{ $barang->stok > 10 ? 'bg-green-100 text-green-700' : ($barang->stok > 0 ? 'bg-blue-100 text-blue-700' : 'bg-red-100 text-red-700') }}">
                                        {{ $barang->stok }}
                                    </span>
                                </td>
                                <td>
                                    <button type="button"
                                        class="btn-select-product text-blue-600 hover:text-blue-700 font-medium {{ $barang->stok < 1 ? 'opacity-50 cursor-not-allowed' : '' }}"
